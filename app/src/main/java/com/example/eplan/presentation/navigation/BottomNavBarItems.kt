...
sealed class BottomNavBarItems(var route: String, var icon: Int, var title: String) {
    object Home : BottomNavBarItems("home", R.drawable.ic_baseline_note_add_24, "Foglio ore")
    object Appointments : BottomNavBarItems("appointments", R.drawable.ic_baseline_date_range_24, "Appuntamenti")
